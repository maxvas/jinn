...
#include "../../../src/qhttpparser/qhttprequest.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QHttpRequest_t, stringdata) + ofs \
...
const QMetaObject QHttpRequest::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QHttpRequest.data,
      qt_meta_data_QHttpRequest,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHttpRequest.stringdata))
