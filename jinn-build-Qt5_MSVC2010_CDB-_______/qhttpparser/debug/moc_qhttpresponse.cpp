...
#include "../../../src/qhttpparser/qhttpresponse.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QHttpResponse_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 47, 8)
    ...
    "QHttpResponse\0beforeSendHeaders\0\0"
    "sendData\0data\0finished\0"
};
...
void QHttpResponse::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->beforeSendHeaders(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHttpResponse::beforeSendHeaders)) {
                *result = 0;
            }
        }
        {
            typedef void (QHttpResponse::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHttpResponse::sendData)) {
                *result = 1;
            }
        }
        {
            typedef void (QHttpResponse::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHttpResponse::finished)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject QHttpResponse::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QHttpResponse.data,
      qt_meta_data_QHttpResponse,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHttpResponse.stringdata))
...
// SIGNAL 0
void QHttpResponse::beforeSendHeaders()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void QHttpResponse::sendData(QByteArray _t1)
{
